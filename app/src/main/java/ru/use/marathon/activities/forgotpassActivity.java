...
import static ru.use.marathon.models.RestoreCode.success;


public class forgotpassActivity extends AbstractActivity {
                ...
                String password = passwordEditText.getText().toString();
                    AppController.getApi().sendPHPMail(1, "sendPHPMail", email).enqueue(new Callback<JsonObject>() {
                        ...
                        public void onFailure(Call<JsonObject> call, Throwable t) {
                            ...
                            Toast.makeText(forgotpassActivity.this, "Big problem ", Toast.LENGTH_SHORT).show();
                        }
                    });
